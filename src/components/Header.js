        ...
        <div className='header'>
            ...
            <div className='categories'>
                <ul className='navbar'>
                    ...
                    <Link to="/rating"><li className='link' onClick={() => { setFilterOnClick("rating") }}>RATING</li></Link>
                    <Link to="/delivery-time"><li className='link' onClick={() => { setFilterOnClick("delivery-time") }}>DELIVERY TIME</li></Link>
                    <Link to="/cost-low-to-high"><li className='link' onClick={() => { setFilterOnClick("cost-low-to-high") }}>COST: LOW TO HIGH</li></Link>
                    <Link to="/cost-high-to-low"><li className='link' onClick={() => { setFilterOnClick("cost-high-to-low") }}>COST: HIGH TO LOW</li></Link>
                </ul>
            </div>
            <h4 style={{ textTransform: "capitalize" }}>{context.filter}</h4>
        </div>
    )
}
