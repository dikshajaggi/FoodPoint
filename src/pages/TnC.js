    ...
    return (
        <MainTncWrapper>
            ...
            <TncWrapper>
                ...
                <br></br>
                These Terms and Conditions ("Terms") govern your use of the Hunger Bites website, mobile application, and related services (collectively referred to as the "Service"). By accessing or using the Service, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use the Service.
                <br></br>
                <br></br>
                ...
                All content and materials available through the Service, including but not limited to text, graphics, logos, images, and software, are the property of Hunger Bites or its licensors and are protected by copyright, trademark, and other intellectual property laws.
                <br></br>
                <br></br>

                <h6>Limitation of Liability:</h6>
                To the fullest extent permitted by applicable law, Hunger Bites and its affiliates, officers, directors, employees, agents, and licensors shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising out of or in connection with your use of the Service.
                <br></br>
                <br></br>
